...
class LegacyReviewAdapterControllerTest {
    ...
    void legacyPatchPersistsThroughDomainModelAndDoesNotCallReviewStoreUpdate() throws Exception {
        ...
        mockMvc.perform(patch("/api/ai/review/multi-legacy")
        ...
        verify(legacyStore, never()).updateReview(org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.any());
