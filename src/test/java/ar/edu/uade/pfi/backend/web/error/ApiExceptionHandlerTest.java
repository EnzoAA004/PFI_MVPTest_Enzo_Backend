...
class ApiExceptionHandlerTest {
  ...
  void responseStatusExceptionUsesStandardErrorShapeAndTraceId() throws Exception {
    ...
    mockMvc
        .perform(get("/boom/not-found").header(TraceIdFilter.TRACE_ID_HEADER, "demo-trace-err"))
  ...
  void runtimeExceptionIsMaskedAsInternalError() throws Exception {
    ...
    mockMvc
        .perform(get("/boom/runtime").header(TraceIdFilter.TRACE_ID_HEADER, "demo-trace-500"))
