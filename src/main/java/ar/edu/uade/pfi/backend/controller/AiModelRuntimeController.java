...
/**
 * Internal model runtime configuration (pytorch device/version, artifact state) is ADMIN-only for
 * the same reason as /api/ai/readiness and /api/ai/models/verify.
 */
@RestController
...
public class AiModelRuntimeController {
  ...
  public AiModelRuntimeController(
      AiServiceClient aiServiceClient, RoleAuthorizationService authorizationService) {
