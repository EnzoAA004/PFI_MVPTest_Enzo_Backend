 ...
 * (AiStructuredErrorV2Dto), translated to a stable backend error code. Never carries
 * the upstream stack trace or full response body.
 */
public class AiMultiplanarUpstreamException extends RuntimeException {
    ...
    public AiMultiplanarUpstreamException(HttpStatus status, String code, String message, String aiTraceId) {
        super(message);
        this.status = status;
        this.code = code;
