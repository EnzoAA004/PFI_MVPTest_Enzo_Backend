...
/**
 * Thrown when the professional activation/approval flow targets an account that already
 * carries ADMIN — that flow may only ever touch DOCTOR/REVIEWER accounts. Administrator
 * accounts are managed through a separate, dedicated flow (not implemented here).
 */
