...
public class AiCompletionController {
  ...
  public Map<String, Object> completion() {
    ...
    return Map.of(
        "status",
        "mvp_completion_ready",
        "completionPercent",
        Math.round(complete * 100.0 / 6.0),
        "items",
        List.of("backend", "ai_module", "traceability", "human_review", "readiness", "reports"),
        "aiMvpCompletion",
        readiness.getOrDefault("mvpCompletion", Map.of()),
        "roadmap",
        roadmapSummary(),
        "latestRunId",
  ...
  private Map<String, Object> roadmapSummary() {
    return Map.of(
        ...
        "pending",
            List.of(
                "real_model_artifact",
                "quantitative_dataset_evaluation",
                "professional_validation_round"),
        "acceptanceCriteria",
            List.of(
