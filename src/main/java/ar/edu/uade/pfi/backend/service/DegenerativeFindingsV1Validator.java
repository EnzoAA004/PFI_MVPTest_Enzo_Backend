...
public class DegenerativeFindingsV1Validator {
    ...
    private void validateClassification(DegenerativeFindingsV1Dto.Classification classification) {
        ...
        Map<DegenerativeFindingSeverityV1, Double> values = new EnumMap<>(DegenerativeFindingSeverityV1.class);
        ...
        DegenerativeFindingSeverityV1 argmax = values.entrySet().stream()
    ...
    private void validateEvaluation(DegenerativeFindingsV1Dto.Evaluation evaluation) {
        ...
        require(evaluation.reasonCode() == null || hasText(evaluation.reasonCode()), "evaluation.reasonCode must be non-empty when present");
    }
    ...
    private void validateSourceSeries(DegenerativeFindingsV1Dto.SourceSeries sourceSeries) {
        ...
        require(sourceSeries.position() != null && sourceSeries.position() >= 0, "sourceSeries.position must be non-negative");
    }
    ...
    private void validateLocalization(DegenerativeFindingsV1Dto.Localization localization) {
        ...
        if (localization.source() == DegenerativeFindingLocalizationSourceV1.EXTERNAL_COORDINATE) {
            require(Boolean.TRUE.equals(localization.researchOnly()), "external_coordinate requires researchOnly=true");
        }
    }
