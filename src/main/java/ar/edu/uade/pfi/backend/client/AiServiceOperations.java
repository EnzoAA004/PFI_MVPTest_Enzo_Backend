...
public interface AiServiceOperations {
    ...
    default DiscDegenerativeFindingsV1Dto predictDiscDegenerative(Map<String, Object> request) {
        throw new UnsupportedOperationException("disc_degenerative_predict_unavailable");
    }
