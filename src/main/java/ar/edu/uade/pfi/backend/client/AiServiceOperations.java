...
public interface AiServiceOperations {
   ...
   *
   * <p>Son lo que permite abrir los resultados en 3D Slicer, OHIF o un PACS de hospital sin este
   * software en el medio. Se construyen en el momento del lado del modulo de IA: no son assets
   * escritos en disco.
   */
  ...
  /**
   * Clasificacion subarticular sobre una coordenada marcada a mano. Es puntual: no forma parte de
   * una corrida y no persiste nada.
   */
  default SubarticularPredictionResponseDto predictSubarticular(
