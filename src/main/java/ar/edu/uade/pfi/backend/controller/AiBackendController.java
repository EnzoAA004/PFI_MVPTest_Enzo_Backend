...
public class AiBackendController {
  ...
  public StudyUploadResponseDto uploadStudy(
      @RequestParam("file") MultipartFile file, @RequestParam String caseId) {
  ...
  public ResponseEntity<byte[]> getAsset(
      @PathVariable String runId, @PathVariable String plane, @PathVariable String assetName) {
  ...
  public ReviewStatusDto updateReview(
      @PathVariable String runId, @Valid @RequestBody ReviewUpdateRequestDto request) {
  ...
  public List<MeasurementSaveDto> saveMeasurements(
      @PathVariable String runId, @RequestBody MeasurementBatchDto request) {
